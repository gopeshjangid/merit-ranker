...
import { BasicBlocksKit } from '@/features/presentations/components/plate/plugins/basic-blocks-kit';
...
import { MediaKit } from '@/features/presentations/components/plate/plugins/media-kit';
