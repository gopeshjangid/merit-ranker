...
export const circleVariants = cva(
  'relative flex size-10 shrink-0 items-center justify-center rounded-full text-sm font-bold ring-1 ring-[var(--ring-color)] ring-offset-2',
  {
    variants: {
      orientation: {
        horizontal: '',
...
export const lineVariants = cva('', {
  variants: {
    ...
    showLine: {
      true: "before:absolute before:z-50 before:rounded-full before:bg-[var(--before-bg)] before:content-['']",
      false: '',
    },
    isEven: {
      true: '',
